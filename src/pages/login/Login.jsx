          ...
          <Card className="page"
           style={{marginTop:"10%",
               ...
               <div className="inputs">
                    <div className="input">
                         <Text style={{fontSize:"20px",color:"rgb(248,68,100)",fontWeight:"bold"}}>{labels("UserName")}  </Text>
                         <input style={{marginLeft:"1%"}} value={formData.userName} onChange={(e) => setFormData({ userName: e.target.value })} type="text" />
                    </div>
                    <div className="input">
                    <Text style={{fontSize:"20px",color:"rgb(248,68,100)",fontWeight:"bold"}}>{labels("Password")} </Text>
                    ...
                    <div className="button" style={{color:"rgb(248,68,100)",fontStyle:"oblique",fontWeight:"bold"}}>
                         <Button style={{color:"rgb(248,68,100)",fontStyle:"oblique",fontWeight:"bold", marginLeft:"37%",fontSize:"25px", height:'17%'}} onClick={doLogin} >{labels("Login")}</Button>
                    </div>
                    {errorMessage &&
